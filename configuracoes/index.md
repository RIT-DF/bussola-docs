...
nav_order: 7
has_children: true
permalink: /configuracoes/
---

# Configurações da Organização

Configurações disponíveis para administradores e tesoureiros da OSC.

| Seção | Descrição |
|---|---|
| [Organização](/configuracoes/organizacao/) | Dados da OSC e integrações (WooCommerce, Google Drive) |
