...
Esta página mostra **o estado de cada funcionalidade** do Bússola Financeira — o que já está em produção, o que está sendo desenvolvido agora, o que está planejado para mais à frente, e o que só será implementado **se houver demanda**.
...
>
> Clique no botão **FEEDBACK** em qualquer tela do Bússola Financeira — sua mensagem chega direto à equipe da RIT e pode acelerar a priorização de algo que você precisa.
...
> Tema novo, planejado como uma **onda dedicada na V2** do Bússola — gestão de compras com cotação de fornecedores antes da autorização do pagamento.
