...
1. No topo do aplicativo, clique no botão **💬 Feedback**.
...
Ao escolher o tipo **Depoimento**, aparece uma opção a mais: autorizar (ou não) que a RIT **publique** o seu depoimento. Fica a seu critério — sem a autorização, ele é guardado apenas como feedback interno.
