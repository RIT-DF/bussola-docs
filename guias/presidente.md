...
> 💡 **A ideia central**
>
> A responsabilidade do presidente é ampla — e é justamente por isso que ele **não pode depender de fazer tudo à mão**. O segredo não é controlar cada detalhe; é **ter visão do todo e delegar com clareza**. Um bom presidente monta uma equipe de confiança, dá a cada um o acesso certo, e mantém para si a capacidade de, a qualquer momento, abrir o sistema e ver como a OSC está. Responsabilidade com visão é leve; responsabilidade sem visão é que pesa.

## 1. O que se espera de você

- **Representar** a OSC e responder por ela.
- **Delegar** com clareza — dar a cada pessoa o papel e o acesso adequados.
- **Supervisionar** — acompanhar o financeiro, os projetos e as pendências sem precisar operar cada um.
- **Decidir e aprovar** o que é da alçada da presidência.
- **Garantir a prestação de contas** — que ela exista, seja correta e chegue a quem precisa.

Repare: nenhuma dessas funções é "lançar cada conta de luz" ou "conferir cada nota". É **acompanhar e garantir** — e isso o sistema faz caber no seu tempo.

## 2. Delegar sem perder o controle

O instrumento mais poderoso do presidente é a **delegação bem feita**. Dar a cada pessoa exatamente o acesso de que ela precisa — nem mais, nem menos — protege a todos: você delega sem abrir mão da supervisão, e cada um atua sem carregar responsabilidade que não é sua.
...
## 4. Acompanhar os projetos como um portfólio
...
## 5. Aprovar o que importa — e só o que importa
...
>
> [![Relatórios — visão geral](/assets/screenshots/manual-relatorios-01-visao-geral.png)](/assets/screenshots/manual-relatorios-01-visao-geral.png)
...
- [ ] Tesouraria e conselho fiscal com o acesso de que precisam.
